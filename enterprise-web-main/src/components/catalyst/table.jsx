    ...
    <TableRowContext.Provider value={{ href, target, title }}>
      <tr
        ...
        className={clsx(
          className,
          href &&
            'has-[[data-row-link][data-focus]]:outline has-[[data-row-link][data-focus]]:outline-2 has-[[data-row-link][data-focus]]:-outline-offset-2 has-[[data-row-link][data-focus]]:outline-red-500 dark:focus-within:bg-white/[2.5%]',
