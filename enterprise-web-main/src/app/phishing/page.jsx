...
const Sidebar = ({ children, isOpen, onClose, darkMode }) => (
    <aside className={`bg-white dark:bg-neutral-800 text-neutral-800 dark:text-white w-64 min-h-screen fixed left-0 top-0 bottom-0 transition-transform duration-200 ease-in-out z-50 ${isOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col`}>
        ...
        <SidebarLink href="/dashboard" icon={<FontAwesomeIcon icon={faHome} />}>Dashboard</SidebarLink>
        <SidebarLink href="/dashboard" icon={<FontAwesomeIcon icon={faChartLine} />}>Analytics</SidebarLink>
        <SidebarLink href="/dashboard" icon={<FontAwesomeIcon icon={faCog} />}>Settings</SidebarLink>
        <hr className='mt-4 border-neutral-700'></hr>
        <b className='mt-4 ml-3 text-sm text-neutral-400'>PRODUCTS </b>
        <SidebarLink href="/phishing" icon={<FontAwesomeIcon icon={faWater} />}>FirstWave</SidebarLink>
        ...
        <SidebarLink href="/phishing" className='ml-3' icon={<FontAwesomeIcon icon={faHeart} />}>Organization Health</SidebarLink>
        <SidebarLink href="/phishing" icon={<FontAwesomeIcon icon={faShieldAlt} />}>Guardian</SidebarLink>
        <SidebarLink href="/phishing" icon={<FontAwesomeIcon icon={faEye} />}>Sentry</SidebarLink>
