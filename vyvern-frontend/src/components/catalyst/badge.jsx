...
const colors = {
  ...
  red: 'bg-red-500/15 text-red-700 group-data-[hover]:bg-red-500/25 dark:text-red-400 dark:group-data-[hover]:bg-red-500/25',
  indigo:
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    'group relative inline-flex rounded-md focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-red-500'
  )
