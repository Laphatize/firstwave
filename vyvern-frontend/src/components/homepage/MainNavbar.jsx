            ...
            <div className={`fixed top-0 left-0 right-0 z-[9999] transition-all duration-300 ${
                ...
                <nav className="relative flex justify-between items-center px-4 mx-auto max-w-7xl py-4">
                            ...
                            <div className="flex">
                                <h1 className="text-xl text-white">
                                    <span className="text-white font-medium">
                                        Vyvern <span className='text-xs font-light'>EARLY ALPHA</span>
                                    </span>
                                </h1>
                            </div>
                        </Link>
                    ...
                    <div className="md:flex items-center gap-x-5 ">
                        <Link className="hidden text-white text-sm" href="/login">
                            Login
                        </Link>
                        <Button href="login" className="hidden " color="red">
                            <span>
                                Get started <span className="hidden lg:inline">today</span>
                            </span>
                        </Button>

                        <p className="hidden md:block text-white text-sm">Coming soon</p>
                    </div>
