                ...
                <div className="space-y-3">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2 bg-neutral-900/50 border border-neutral-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      ...
                      className="w-full text-white px-3 py-2 bg-neutral-900/50 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                    />
                    <div className="relative">
                      <input
                        type="email"
                        ...
                        className="w-full px-3 py-2 text-white bg-neutral-900/50 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                      />
                      {personSearchLoading && (
                        <div className="absolute right-3 top-2.5">
                          <svg className="animate-spin h-4 w-4 text-neutral-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-neutral-900/50 border border-neutral-700/50 rounded-lg">
                  <div className="flex items-center gap-2 text-amber-400">
                    <p className="text-sm">
                      Be specific about your objective. This helps the AI better understand what information to seek during the test.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                  <div className="flex items-center gap-2 text-amber-400">
                    ...
                    <p className="text-sm">
                      This step is required to ensure the test's effectiveness and authenticity.
                    </p>
                  </div>
                </div>
              </div>
      ...
      >
        {tutorialStep === 1 ? (
          <div className="space-y-6">
            ...
            <h3 className="text-lg font-medium text-white text-center">Welcome to Tests</h3>
            <p className="text-sm text-neutral-400 text-center">
              Tests help you organize and automate your security assessments.
            </p>
              ...
              <div className="bg-neutral-900 p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-white">Example Test</h4>
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-neutral-400 text-center">
              Tests are the actual security assessments performed based on your test settings.
            </p>
          ...
          <main className="lg:pr-96">
            <header className="flex items-center justify-between border-b border-white/5 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
              ...
              >
                ...
                <span className="text-white font-medium text-sm">New Test</span>
              </button>
            </header>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            >
              <h3 className="text-xl font-semibold mb-4 text-white">
                {step === 1 ? 'Create New Test' : step === 2 ? 'Configure Test Settings' : 'Verify LinkedIn'}
              </h3>
              {renderModalContent()}
            </motion.div>
          </div>
